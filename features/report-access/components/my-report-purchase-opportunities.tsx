        ...
        <section className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-[#6b7280]">
              Wybierz typ raportu, a następnie zakończoną sesję, dla której
          ...
          <div className="grid gap-3">
            {data.sessionReportOffers.map((offer) => (
              <MySessionReportPurchaseCard
                key={`${offer.product.id}-${offer.reportTemplate.id}`}
      ...
      {hasSpecialOffers ? (
        <section className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-[#6b7280]">
              Raport specjalny jest dostępny po wypełnieniu określonej konfiguracji kwestionariuszy.
            </p>
          </div>
                ...
                <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-center">
                  ...
                  <div className="flex md:justify-end">
                    {offer.canBuy ? (
                      ...
                      >
                        <Link
                          href={`/my/assessment/composite-reports/${offer.reportTemplateVersion.id}/unlock?tenant=${encodeURIComponent(
                            offer.tenantSlug,
                          )}`}
                        >
                          Odblokuj raport
